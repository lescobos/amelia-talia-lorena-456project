...
In order to dive deeper into the effects of climate change on ocean health, we considered 3 different locations all around the world that we are calling "case studies" all of which help answer our research questions: How is ocean health affected by increases in sea surface temperature? How do seasonal fluctuations of ENSO (El Niño-Southern Oscillation) affect over all ocean health? 
