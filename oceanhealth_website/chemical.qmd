...
![](Images/oceanphoto.jpeg){width="358"}
...
[![](Images/pHScale.png)](https://www.epa.gov/sites/default/files/2016-11/acidity-ph-scale-figure-2016.png) Image Source: [EPA](https://www.epa.gov/sites/default/files/2016-11/acidity-ph-scale-figure-2016.png)
...
nineyears <- read.csv("Data/nineyears.csv")
```
...
#tiff <- raster("MYD28M_2022-12-01_rgb_3600x1800.FLOAT.TIFF")
